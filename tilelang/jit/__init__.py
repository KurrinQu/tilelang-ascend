        ...
        def wrapper(*args: _P.args, **kwargs: _P.kwargs) -> Any:
            ...
            if key not in self._kernel_cache:
                ...
                if self.debug_root_path:
                    ...
                    device_mod = f'tilelang_jit_kernel_{func_name}.tvm'
                    ...
                    with open(path.join(self.debug_root_path, device_mod), 'w') as f:
                        print(kernel_result.artifact.device_mod, file=f)
